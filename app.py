...
ideas = {
    1:{
        "id":1,
        "idea_name":"ONDC",
        "idead_description":"Details about ONDC",
        "idea_author":"Adeeb"
    },
    2:{
        "id":2,
        "idea_name":"Save Soil",
        "idead_description":"Details about Saving Soil",
...
'''
Create a RESTful endpoint for creating a anew idea
'''
@app.post("/ideaapp/api/v1/ideas")
def create_idea():
    #Logic to create a anew idea
